...
/**
 * Item in *Bento → Default → Primary → Bento Items*
 */
export interface BentoSliceDefaultPrimaryBentoItemsItem {
  /**
   * Title field in *Bento → Default → Primary → Bento Items*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_items[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Body field in *Bento → Default → Primary → Bento Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_items[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Bento Items*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_items[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Bento Items*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.bento_items[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Bento Items field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_items[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  bento_items: prismic.GroupField<
    Simplify<BentoSliceDefaultPrimaryBentoItemsItem>
  >;
}
...
export interface CaseStudiesSliceDefaultPrimaryCasesItem {
  /**
   * Case Study field in *CaseStudies → Default → Primary → Cases*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.cases[].case_study
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface IntegrationsSliceDefaultPrimaryIconsItem {
  /**
   * Item field in *Integrations → Default → Primary → Icons*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.icons[].item
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  item: prismic.SelectField<
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryBentoItemsItem,
